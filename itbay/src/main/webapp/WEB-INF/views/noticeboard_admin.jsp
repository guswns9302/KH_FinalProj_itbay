...
<section class="container p-5 my-5">
	<div class="clearfix" style="margin-top:10px;">
		<c:if test="${sessionScope.loginMember.username eq '마스터' }">
			<span class="float-start"><button type="button" class="btn btn-secondary text-uppercase" style="width: 183px;" onclick="location.href='/noticeWrite'">공지 등록</button></span>
		</c:if>
		<span class="float-end">
			<select onchange="location.href='/notice_board_admin?cnt=' + this.value" class="btn btn-secondary text-uppercase">
